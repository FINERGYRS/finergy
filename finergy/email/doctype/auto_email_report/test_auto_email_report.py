...
import finergy
from finergy.utils import add_to_date, get_link_to_form, today
from finergy.utils.data import is_html

# test_records = finergy.get_test_records('Auto Email Report')


class TestAutoEmailReport(unittest.TestCase):
	def test_auto_email(self):
		finergy.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not finergy.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = finergy.get_doc(
			dict(
		...
		auto_email_report = finergy.get_doc("Auto Email Report", "Permitted Documents For User")
