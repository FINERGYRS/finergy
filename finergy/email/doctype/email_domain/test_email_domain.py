...
test_records = finergy.get_test_records("Email Domain")
...
class TestDomain(unittest.TestCase):
	...
	def tearDown(self):
		finergy.delete_doc("Email Account", "Test")
		finergy.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = finergy.get_doc("Email Domain", "test.com")
		mail_account = finergy.get_doc("Email Account", "Test")
