...
finergy.ui.form.on("Email Domain", {
	...
	refresh:function(frm){
		...
		if (frm.doc.__islocal != 1 && finergy.route_flags.return_to_email_account) {
			var route = finergy.get_prev_route();
			delete finergy.route_flags.return_to_email_account;
			finergy.route_flags.set_domain_values = true
