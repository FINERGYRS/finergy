...
from finergy import safe_decode
from finergy.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from finergy.email.queue import get_email_queue, prepare_message
from finergy.email.receive import Email
...
<div>
	...
	<img embed="assets/finergyrs/images/finergy-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/finergyrs/images/finergy-favicon.svg")
...
Content-Disposition: inline; filename="finergy-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/finergyrs/images/finergy-favicon.svg" alt="test" />
