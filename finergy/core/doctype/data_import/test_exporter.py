...
from finergy.core.doctype.data_import.test_importer import create_doctype_if_not_exists
...
class TestExporter(unittest.TestCase):
	...
	def test_exports_specified_fields(self):
		if not finergy.db.exists(doctype_name, "Test"):
			doc = finergy.get_doc(
			...
			doc = finergy.get_doc(doctype_name, "Test")
	...
	def test_export_csv_response(self):
		...
		self.assertEqual(finergy.response["doctype"], doctype_name)
