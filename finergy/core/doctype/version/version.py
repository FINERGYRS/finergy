...
class Version(Document):
	...
	def set_diff(self, old: Document, new: Document) -> bool:
		...
		if diff:
			...
			self.data = finergy.as_json(diff, indent=None, separators=(",", ":"))
			return True
		else:
			return False
	...
	def for_insert(self, doc: Document) -> bool:
		...
		self.data = finergy.as_json(data, indent=None, separators=(",", ":"))
		return True
...
def on_doctype_update():
	finergy.db.add_index("Version", ["ref_doctype", "docname"])
