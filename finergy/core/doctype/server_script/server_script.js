...
finergy.ui.form.on('Server Script', {
	setup: function(frm) {
...
if finergy.form_dict.message == "ping":
	finergy.response['message'] = "pong"
else:
	finergy.response['message'] = "ok"
</code></pre>
...
tenant_id = finergy.db.get_value(...)
