...
class TestRoleProfile(unittest.TestCase):
	def test_make_new_role_profile(self):
		finergy.delete_doc_if_exists("Role Profile", "Test 1", force=1)
		new_role_profile = finergy.get_doc(dict(doctype="Role Profile", role_profile="Test 1")).insert()
