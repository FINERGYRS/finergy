...
finergy.ui.color = {
	get: function(color_name, shade) {
		...
		return finergy.ui.color_map;
	},
	get_color: function(color_name) {
		const color_names = Object.keys(finergy.ui.color_map);
		if(color_names.includes(color_name)) {
			return finergy.ui.color_map[color_name];
		} else {
	...
	all: function() {
		return Object.values(finergy.ui.color_map)
			.reduce((acc, curr) => acc.concat(curr) , []);
	},
	names: function() {
		return Object.keys(finergy.ui.color_map);
	},
	...
	get_color_name: function(hex) {
		for (const key in finergy.ui.color_map) {
			const colors = finergy.ui.color_map[key];
...
finergy.ui.color_map = finergy.ui.color.get_color_map();
