...
finergy.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = finergy.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return finergy.require(
			"/assets/finergyrs/node_modules/html5-qrcode/dist/html5-qrcode.min.js"
		);
	}
};
