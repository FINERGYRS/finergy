...
finergy.ready(function() {
	let query_params = finergy.utils.get_query_params();
	...
	function show_login_prompt() {
		const login_required = new finergy.ui.Dialog({
	...
	function show_form() {
		...
		function get_data() {
			return finergy.call({
				method: "finergy.website.doctype.web_form.web_form.get_form_data",
				args: {
					doctype: webform_doctype,
					docname: doc_name,
					web_form_name: webform_name
