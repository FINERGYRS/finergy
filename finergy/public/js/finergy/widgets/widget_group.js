...
finergy.provide("finergy.widget");

finergy.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
finergy.widget.make_widget = (opts) => {
	const widget_class = finergy.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = finergy.widget.make_widget({
			...widget,
...
finergy.widget.WidgetGroup = WidgetGroup;
