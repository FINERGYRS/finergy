finergy.ui.form.set_user_image = function(frm) {
...
finergy.ui.form.setup_user_image_event = function(frm) {
	// re-draw image on change of user image
	if(frm.meta.image_field) {
		finergy.ui.form.on(frm.doctype, frm.meta.image_field, function(frm) {
			finergy.ui.form.set_user_image(frm);
		});
	}
