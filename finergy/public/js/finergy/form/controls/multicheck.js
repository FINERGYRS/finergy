finergy.ui.form.ControlMultiCheck = finergy.ui.form.Control.extend({
	...
	parse_df_options() {
		...
		} else if(this.df.options && this.df.options.length>0 && finergy.utils.is_json(this.df.options)) {
