finergy.ui.form.ControlCurrency = finergy.ui.form.ControlFloat.extend({
	...
	get_precision: function() {
		...
		if (!this.df.precision) {
			if(finergy.boot.sysdefaults.currency_precision) {
				this.df.precision = finergy.boot.sysdefaults.currency_precision;
			} else {
