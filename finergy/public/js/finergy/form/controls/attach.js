finergy.ui.form.ControlAttach = finergy.ui.form.ControlData.extend({
	make_input: function() {
		let me = this;
		...
		finergy.utils.bind_actions_with_object(this.$value, this);
	...
	on_attach_click() {
		...
		this.file_uploader = new finergy.ui.FileUploader(this.upload_options);
	},
	set_upload_options() {
		let options = {
