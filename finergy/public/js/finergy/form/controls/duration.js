finergy.ui.form.ControlDuration = finergy.ui.form.ControlData.extend({
	make_input: function() {
		this._super();
		this.make_picker();
	},
	...
	set_duration_options() {
		this.duration_options = finergy.utils.get_duration_options(this.df);
	},

	set_duration_picker_value: function(value) {
		let total_duration = finergy.utils.seconds_to_duration(value, this.duration_options);
	...
	bind_events: function() {
		...
		this.$picker.on("change", ".duration-input", () => {
			...
			let value = finergy.utils.duration_to_seconds(
				duration.days,
				duration.hours,
				duration.minutes,
				duration.seconds
	...
	format_for_input: function(value) {
		return finergy.utils.get_formatted_duration(value, this.duration_options);
	},
