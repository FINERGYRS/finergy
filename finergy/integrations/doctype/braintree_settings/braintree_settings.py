...
from finergy.utils import call_hook_method, get_url
		...
		if self.flags.status_changed_to == "Completed":
			...
			if self.data.reference_doctype and self.data.reference_docname:
				...
				try:
					...
					braintree_success_page = finergy.get_hooks("braintree_success_page")
					if braintree_success_page:
						custom_redirect_to = finergy.get_attr(braintree_success_page[-1])(self.data)
				except Exception:
					finergy.log_error(finergy.get_traceback())
...
def get_gateway_controller(doc):
	payment_request = finergy.get_doc("Payment Request", doc)
...
def get_client_token(doc):
	...
	settings = finergy.get_doc("Braintree Settings", gateway_controller)
