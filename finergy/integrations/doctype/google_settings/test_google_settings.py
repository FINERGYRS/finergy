...
class TestGoogleSettings(unittest.TestCase):
	def setUp(self):
		settings = finergy.get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		finergy.db.set_value("Google Settings", None, "enable", 1)
		finergy.db.set_value("Google Settings", None, "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		finergy.db.set_value("Google Settings", None, "enable", 0)
		finergy.db.set_value("Google Settings", None, "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()
