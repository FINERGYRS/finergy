...
from finergy.utils import call_hook_method, cint, flt, get_url
	...
	def validate_stripe_credentails(self):
		if self.publishable_key and self.secret_key:
			...
			try:
				...
				finergy.throw(_("Seems Publishable Key or Secret Key is wrong !!!"))
	...
	def create_charge_on_stripe(self):
		...
		try:
			...
			if charge.captured == True:
				...
				finergy.log_error(charge.failure_message, "Stripe Payment not completed")
