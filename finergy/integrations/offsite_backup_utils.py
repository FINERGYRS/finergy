...
import finergy
from finergy.utils import cint, split_emails
...
def send_email(success, service_name, doctype, email_field, error_status=None):
	...
	if success:
		if not finergy.db.get_single_value(doctype, "send_email_for_successful_backup"):
			return
...
def get_recipients(doctype, email_field):
	...
	return split_emails(finergy.db.get_value(doctype, None, email_field))


def get_latest_backup_file(with_files=False):
	from finergy.utils.backups import BackupGenerator
