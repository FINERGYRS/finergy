...
def finergycloud_migrator(local_site):
	print("Retrieving Site Migrator...")
	remote_site = finergy.conf.finergycloud_url or "finergycloud.com"
	...
	if request.status_code / 100 != 2:
		...
		click.secho(
			"Some errors occurred while recovering the migration script. Please contact us @ Finergy Cloud if this issue persists",
			fg="yellow",
		)
		return
