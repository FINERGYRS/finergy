...
from finergy.utils import add_to_date, get_datetime, getdate
...
def get_user_date_format():
	if getattr(finergy.local, "user_date_format", None) is None:
		finergy.local.user_date_format = finergy.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return finergy.local.user_date_format
