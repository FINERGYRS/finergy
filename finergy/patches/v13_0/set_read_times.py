...
import finergy
from finergy.utils import markdown, strip_html_tags


def execute():
	finergy.reload_doc("website", "doctype", "blog_post")

	for blog in finergy.get_all("Blog Post"):
		blog = finergy.get_doc("Blog Post", blog.name)
