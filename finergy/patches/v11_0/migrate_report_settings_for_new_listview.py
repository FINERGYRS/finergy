...
def execute():
	...
	reports = finergy.get_all("Report", {"report_type": "Report Builder"})

	for report_name in reports:
		settings = finergy.db.get_value("Report", report_name, "json")
		if not settings:
			continue

		settings = finergy._dict(json.loads(settings))
		...
		finergy.db.set_value("Report", report_name, "json", json.dumps(settings))
