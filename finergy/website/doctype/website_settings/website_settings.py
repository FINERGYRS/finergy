...
from finergy.utils import encode, get_request_site_address
from finergy.website.doctype.website_theme.website_theme import add_website_theme
...
class WebsiteSettings(Document):
	...
	def validate_google_settings(self):
		if self.enable_google_indexing and not finergy.db.get_single_value("Google Settings", "enable"):
	...
	def get_access_token(self):
		...
		if not self.indexing_refresh_token:
			button_label = finergy.bold(_("Allow API Indexing Access"))
		...
		try:
			...
			button_label = finergy.bold(_("Allow Google Indexing Access"))
			finergy.throw(
				_(
...
def get_website_settings(context=None):
	...
	context = context or finergy._dict()
	...
	settings: "WebsiteSettings" = finergy.get_single("Website Settings")
	for k in [
		"banner_html",
		"banner_image",
		"brand_html",
	...
	via_hooks = finergy.get_hooks("website_context")
	...
	if not context.get("favicon"):
		context["favicon"] = "/assets/finergyrs/images/finergy-favicon.svg"
