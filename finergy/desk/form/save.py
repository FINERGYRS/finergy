...
def savedocs(doc, action):
	...
	finergy.msgprint(finergy._("Saved"), indicator="green", alert=True)
...
def cancel(doctype=None, name=None, workflow_state_fieldname=None, workflow_state=None):
	...
	doc.cancel()
	send_updated_docs(doc)
	finergy.msgprint(finergy._("Cancelled"), indicator="red", alert=True)
...
def send_updated_docs(doc):
	...
	finergy.response.docs.append(d)
