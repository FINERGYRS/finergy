finergy.listview_settings['ToDo'] = {
	...
	button: {
		...
		action: function(doc) {
			finergy.set_route('Form', doc.reference_type, doc.reference_name);
		}
	},
	...
	refresh: function(me) {
		...
		me.page.add_sidebar_item(__("Assigned By Me"), function() {
			me.filter_area.add([[me.doctype, "assigned_by", '=', finergy.session.user]]);
