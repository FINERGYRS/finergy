...
test_records = finergy.get_test_records("Note")


class TestNote(unittest.TestCase):
	def insert_note(self):
		finergy.db.sql("delete from tabVersion")
		finergy.db.sql("delete from tabNote")
		finergy.db.sql("delete from `tabNote Seen By`")
	...
	def test_version(self):
		...
		version = finergy.get_doc("Version", dict(docname=note.name))
