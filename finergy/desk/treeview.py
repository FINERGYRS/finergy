...
def get_all_nodes(doctype, label, parent, tree_method, **filters):
	...
	tree_method = finergy.get_attr(tree_method)

	if not tree_method in finergy.whitelisted:
...
@finergy.whitelist()
def add_node():
	args = make_tree_args(**finergy.form_dict)
	doc = finergy.get_doc(args)
